  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.data.data) {
        ...
        setNewTag("");
        // Navigate to home page - using window.location ensures full refresh
        setTimeout(() => {
  ...
  return (
    <Mainlayout>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        <h1 className="text-xl lg:text-2xl font-semibold mb-4 sm:mb-6">
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                {formData.title.length > 0 && (
                  <p className="text-xs text-gray-500 mt-1">
                    {formData.title.length} characters {formData.title.length < 10 && "(minimum 10 required)"}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="min-h-32 lg:min-h-48 w-full resize-y"
                />
                {formData.body.length > 0 && (
                  <p className="text-xs text-gray-500 mt-1">
                    {formData.body.length} characters {formData.body.length < 20 && "(minimum 20 required)"}
                  </p>
                )}
              </div>
              <div>
                ...
                {formData.tags.length >= 5 && (
                  <p className="text-xs text-orange-600 mt-1">Maximum 5 tags reached</p>
                )}
